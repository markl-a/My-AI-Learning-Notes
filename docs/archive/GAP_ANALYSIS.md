...
| 3 | 測試覆蓋率極低 | 程式碼品質 | 20h | TBD | ⏳ 待開始 |
| 4 | 新手入門門檻高 | 新用戶 | 8h | TBD | ⏳ 待開始 |
| 5 | 安全掃描配置問題 | 程式碼安全 | 2h | TBD | ⏳ 待開始 |
