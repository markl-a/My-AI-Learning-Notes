...
youtube 影片參考連結 https://www.youtube.com/watch?v=KBslHtyHRaU

youtube 影片參考連結 https://youtu.be/X_YtuTeUf-4?si=-FGH3ElEX04Zdc-R
...
def analyze_functions(filepath):
    ...
    print(json.dumps(functions_data, indent=2))
