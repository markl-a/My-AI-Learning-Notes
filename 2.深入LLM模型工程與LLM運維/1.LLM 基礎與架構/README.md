...
#### 深度專題
- **[LLM 訓練流程詳解](./LLM訓練流程詳解.md)** - 從預訓練到 RLHF/DPO 的完整訓練流程
- **[注意力機制最新變體與優化](./注意力機制最新變體與優化.md)** - Flash Attention 3, GQA, RoPE 等最新技術
- **[推理模型深度解析](./推理模型_Reasoning_Models_深度解析.md)** - OpenAI o1 與 DeepSeek-R1 詳解
- **[Mixture of Experts 架構詳解](./Mixture_of_Experts_架構詳解.md)** - MoE 架構與 DeepSeek-V3 解析

#### 最新發展
- **[2024-2025 LLM 模型重大突破](./2024-2025_LLM模型重大突破.md)** - GPT-5, Claude 4, Gemini 3.0 等最新模型
...
### 初學者 (從零開始)
1. ✅ 閱讀本 README 了解 Transformer 基礎
2. ✅ 學習 [速查表](./LLM速查表_Quick_Reference.md) 掌握核心概念
3. ✅ 完成 [實戰練習題](./實戰練習題與解答.md) 的初級題目
4. ✅ 實作簡單的注意力機制

### 進階學習者 (有基礎)
1. ✅ 深入學習 [LLM 訓練流程詳解](./LLM訓練流程詳解.md)
2. ✅ 了解 [注意力機制最新變體](./注意力機制最新變體與優化.md)
3. ✅ 研究 [MoE 架構](./Mixture_of_Experts_架構詳解.md) 和 [推理模型](./推理模型_Reasoning_Models_深度解析.md)
4. ✅ 完成中高級練習題
5. ✅ 參考 [最佳實踐指南](./LLM最佳實踐指南.md) 進行實際項目

### 專家級 (實戰導向)
1. ✅ 追蹤 [2024-2025 模型突破](./2024-2025_LLM模型重大突破.md) 了解最新發展
2. ✅ 掌握 [AI 框架與工具](./2025_AI框架與工具生態.md) 生態
3. ✅ 應用最佳實踐於生產環境
4. ✅ 貢獻開源項目和論文研究
...
**2025年1月重大更新** - 本次更新新增了 **5 個專題文檔** 和 **3 個實用資源**:

✅ **完整的訓練流程** - 預訓練、SFT、RLHF、DPO 詳解
✅ **最新注意力優化** - Flash Attention 3、GQA、Paged Attention
✅ **2024-2025 模型突破** - GPT-5, Claude 4, DeepSeek-V3 等
✅ **實用工具對比** - vLLM, SGLang, LangChain 選擇指南
✅ **實戰練習** - 從基礎到高級的完整題庫
✅ **最佳實踐** - 生產環境經驗總結
