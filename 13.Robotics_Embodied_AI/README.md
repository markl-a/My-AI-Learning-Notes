...
> 本章涉及 **VLA 模型版本(π0/π0.5/π0.6、RT-X、Helix、Octo)、人形機器人量產數字(Figure 03 交付、BotQ 產線、Tesla Optimus 估值)、機器人公司融資輪 / 估值** 等高頻變動數字。這些資訊混合三類來源:
> 1. **論文 / 官方 blog / 開源 model card**(高信任度)
> 2. **媒體報導 / 公司新聞稿 / 業內 demo 影片**(屬「報導」非「事實」,且容易被營銷誇大)
> 3. **AI agent 整理 + 我手動驗證**(可能有誤標,尤其 π0.x 版本號、交付數字、量產時程)
>
> 任何要拿來做投資 / 採購 / 招聘決策的數字(估值、交付量、benchmark 成績、能力上限),**請以一手 source 為準**。本章對「VLA 已成為機器人 GPT 時刻」這類 *結構性敘事* 較高信心,對「Figure 03 已交付 350+ / BotQ 每小時 1 台」這類 *精確數字* 較低信心。
